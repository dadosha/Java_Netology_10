...
class PosterManagerTest {
    ...
    public void testFindAll() {
        PosterItem[] actual = posters.findAll();
    ...
    public void testRemovedById() {
        posters.removeById(4);
        PosterItem[] actual = posters.findAll();
        PosterItem[] expected = {item1, item2, item3, item4, item6, item7};

        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void testReversLimitLessPosterCount() {
